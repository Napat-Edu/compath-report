...
\end{minipage}                                                                                                                                                                                                       \\ \hline
 \begin{minipage}{\linewidth}
  ...
  \caption{\centering หน้าหลักสำหรับกดเริ่มวิเคราะห์ Resume}\label{fig:model8}
\end{minipage} \\                          
  \begin{minipage}{\linewidth}
    \centering
    \vspace{1em} % Adjust the space as needed
  \fbox{\includegraphics[width=10cm]{./figure/figure_wireframe_table1_mainpage2.png}}
  \caption{\centering หน้ากรอกข้อมูลของเพื่อนำไปวิเคราะห์}\label{fig:model8}
\end{minipage} \\                                                                                                                                                                                                                            \\ \hline
\begin{minipage}{\linewidth}
  \begin{itemize}
...
\end{minipage}                                                                                                                                                                                                               \\ \hline
  \begin{minipage}{\linewidth}
    \centering
    \vspace{1em} % Adjust the space as needed
  \fbox{\includegraphics[width=10cm]{./figure/figure_wireframe_table1_component1.png}}
  \caption{\centering ช่องสำหรับกรอกข้อมูลของเพื่อนำไปวิเคราะห์}\label{fig:model8}
\end{minipage} \\                                                                                                                                                                                                                                               \\ \hline
\begin{minipage}{\linewidth}
  \begin{itemize}
    \item คำอธิบาย
  \end{itemize}
\end{minipage}                                                                                                                                                                                                                       \\ \hline
\begin{tabular}[c]{@{}l@{}}Resume Checker เป็นฟีเจอร์ที่ให้ผู้ใช้กรอกข้อมูลของเพื่อนำไปวิเคราะห์อาชีพที่เหมาะสม โดยผู้ใช้สามารถการข้อมูลเกี่ยวกับประสบการณ์ทำงาน, การศึกษา, ทักษะ, และคุณสมบัติอื่น ๆ ที่สำคัญ\end{tabular} \\ \hline
\end{tabular}
}
\end{table}
...
\end{minipage} \\                                                                                                                                                                                                                                                                                                                                    \\ \hline
คำอธิบาย                                                                                                                                                                                                                                                                                                               \\ \hline
\begin{tabular}[c]{@{}l@{}}Evaluate Result เป็นฟีเจอร์สำหรับแสดงข้อมูลเชิงลึกของอาชีพที่วิเคราะห์ได้ในตอนแรก โดยจะแสดงข้อมูลที่มีโยชน์เพื่อให้ผู้ใช้สามารถนำไปพัฒนาทักษะของตนเองและเรูเม่ต่อไปได้\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\end{minipage} \\                                                                                                                                                                                                                                                                                                                                                    \\ \hline
คำอธิบาย                                                                                                                                                                                                                                                                                                               \\ \hline
\begin{tabular}[c]{@{}l@{}}Career Node เป็นฟีเจอร์สำหรับแสดงทักษะที่ต้องใช้ในอาชีพต่าง ๆ โดยจะแสดงออกมาในรูปแบบโหนด\end{tabular} \\ \hline
\end{tabular}
\end{table}
...
\end{minipage} \\                                                                                                                                                                                                                                                                                                       \\ \hline
คำอธิบาย                                                                                                                                                                                                                                                                                                               \\ \hline
\begin{tabular}[c]{@{}l@{}}Community เป็นฟีเจอร์สำหรับให้ผู้ใช้สามารถเข้ามาแลกเปลี่ยนข้อมูลหรือความคิดเห็นได้ผ่านการตั้งกระทู้และแสดงความคิดเห็น\end{tabular} \\ \hline
\end{tabular}
\end{table}
