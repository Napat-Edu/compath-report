...
ซึ่งในปัจจุบันจะเหลือเรซูเมเพียง 731 เล่มเท่านั้น
...
หลังจากที่ทางคณะผู้จัดทำได้ทำการเตรียมข้อมูลสำเร็จแล้ว คณะผู้จัดทำก็ได้ทำโมเดลขึ้นมาทั้งหมด 6 โมเดล เพื่อเปรียบเทียบ
ซึ่งเป็นโมเดลสำหรับการจัดหมวดหมู่ ดังตารางต่อไปนี้
\begin{table}[H]
    \begin{tabularx}{\textwidth}{l|l|X|X}
        ...
        \multicolumn{2}{l|}{\multirow{4}{*}{Long Short Term Memory}} & Embedding layer                 & embedding dimension size is 100*100                                      \\ \cline{3-4}
        \multicolumn{2}{l|}{}                                        & Bidirectional LSTM 128 units    & dropout rate 40\%                                                        \\ \cline{3-4}
        \multicolumn{2}{l|}{}                                        & Bidirectional LSTM 64 units     & dropout rate 40\%                                                        \\ \cline{3-4}
        \multicolumn{2}{l|}{}                                        & Dense Layer 25 units            & softmax as activation function                                           \\
    \end{tabularx}
\end{table}
...
ดังตารางที่ \ref{tab:grouping_data} ซึ่งสามารถแสดงผลออกมาเป็นอาชีพที่คาดว่ามีลักษณะใกล้เคียงที่สุด
