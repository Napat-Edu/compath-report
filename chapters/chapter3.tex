...
ทางคณะผู้จัดทำได้ทำแบบสอบถามเพื่อหาอัตราส่วนของพฤติกรรมที่น่าสนใจ โดยได้รับข้อมูลที่น่าสนใจดังนี้
...
\par{
    จากการสำรวจความต้องการของผู้ใช้งานแล้ว ทำให้ทราบถึงปัญหาและสามารถออกแบบมาได้ทั้งหมด 3 ฟีเจอร์หลัก ได้แก่ 
    โมเดลที่สามารถแบ่งประเภทเรซูเมตามสายอาชีพได้ เว็บไซต์ที่แสดงข้อมูลเชิงลึกของแต่ละสายอาชีพ และเว็บไซต์ที่แสดงแผนภาพต้นไม้แสดงความสัมพันธ์ของแต่ละสายอาชีพ
}

\par{
    โดยคณะผู้จัดทำได้ออกแบบส่วนประกอบของระบบที่อ้างอิงจากฟีเจอร์หลักที่กล่าวมา เพื่อให้ทั้งโมเดลกับเว็บไซต์สามารถทำงานได้สอดประสานกันอย่างครบถ้วน 
    และมีประสิทธิภาพ หลังจากที่พัฒนาโมเดลตามขั้นตอนที่กล่าวไว้ข้างต้น และนำไปทดสอบกับผู้ใช้งานจริงโดยแบ่งเป็นสองส่วน ได้แก่ เว็บไซต์ 
    โดยจะให้ผู้ใช้งานจริงประเมินความพึงพอใจในการใช้งาน และโมเดล โดยจะเปรียบเทียบผลลัพธ์ของโมเดลกับความคิดเห็นของผู้เชี่ยวชาญ ซึ่งมีผลการดำเนินงานดังต่อไปนี้
}
