    ...
    \item \textbf{Create recommendations.}
          \begin{table}[H]
              ...
              \begin{tabularx}{\textwidth}{|l|X|l|X|l|}
                  ...
                  \multirow[t]{2}{*}{unclear context} & ไม่มั่นใจว่าต้องกรอกข้อมูลเป็นภาษาอะไร     & Career Prediction  & มีข้อความระบุให้กรอกข้อมูลเป็นภาษาอังกฤษ                  & Medium                  \\ \cline{2-5}
                                                      & ไม่ได้ใช้ resume กรอก                 & Career Prediction  & แบ่ง section การกรอกให้ละเอียดมากขึ้น                  & Difficult               \\ \hline
                  ...
                  \multirow[t]{3}{*}{user interface}  & ไม่รู้ว่ากดดู card history อื่น จากหน้านี้ได้ & Career Insight     & ย้าย section ของการเลือกการ์ดมาไว้ในส่วนที่มองเห็นง่ายกว่านี้ & Medium                  \\ \cline{2-5}
                                                      & ไม่ได้กดไป CE จากหน้านี้                & Career Insight     & ทำ section แนะนำให้ไปดูสายใยอาชีพให้ดึงดูมากกว่านี้          & Medium                  \\ \cline{2-5}
                                                      & สับสนตอนดูผลทำนาย                     & Career Prediction  & ลดจำนวนปุ่ม, ทำเป็น save อัตโนมัติ                        & Medium                  \\ \hline
                  ...
                  \multirow[t]{2}{*}{user interface}  & สับสน กราฟและทักษะ                   & Career Insight     & เขียนอธิบายกราฟว่าเชื่องโยงกับทักษะอย่างไร                & Medium                  \\ \cline{2-5}
                                                      & ไม่รู้ว่ากด Expand ได้                  & Career Exploration & สร้าง tooltips สำหรับการใช้งาน                        & Medium                  \\ \hline
              \end{tabularx}
          \end{table}
\end{enumerate}
