...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\dissadvisor{Asst.Prof.Dr. Suthathip Maneewongvatana}  % Advisor
\def\disscoadvisor{}  % Co-advisor

\def\disscommitteetwo{Asst.Prof.Dr. Phond Phunchongharn}  % 3rd committee member (optional)
\def\disscommitteethree{Asst.Prof.Dr. Priyakorn Pusawiro}   % 4th committee member (optional) 
\def\disscommitteefour{Assoc.Prof.Dr Thumrongrat Amornraksa}    % 5th committee member (optional) 
